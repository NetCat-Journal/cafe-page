...
function Testimonials() {
  return (
    <div className=" px-8 py-15 w-full bg-gradient-to-b from-gray-50 to-white">
      <h2 className="text-center mb-10 text-[#a96522] text-3xl md:text-5xl font-bold">What Our Customers Say</h2>
      <Carousel
        opts={{
          align: "center",
        }}
